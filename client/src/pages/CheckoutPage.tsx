        ...
        <div className="bg-white rounded-lg shadow-sm p-6 h-fit">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className={`w-full mt-6 px-6 py-3 font-medium rounded-lg transition-all duration-200 flex items-center justify-center
    ${
      processingOrder
        ? "bg-gray-400 cursor-not-allowed" // Processing state (grayed out)
        : !selectedAddress
        ? "bg-gray-300 cursor-not-allowed text-gray-500" // Disabled (no address)
        : "bg-green-600 hover:bg-green-700 text-white shadow-md hover:shadow-lg" // Active (ready to order)
    }
  `}
            >
              {processingOrder ? (
